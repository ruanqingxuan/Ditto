...
typedef struct
{
    ...
    /*added by qnwang for AR command ms*/
    ngx_uint_t ditto_expected_time;
    ...
    /* added by jndu */
    ngx_flag_t enable_CS;
    ngx_flag_t can_use_coward;
    ngx_str_t CS_metric_func_path;
    void *metric_cb_handle;
