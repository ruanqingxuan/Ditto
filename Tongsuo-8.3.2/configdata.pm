...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "--prefix=/home/qnwang/worknew/AR/tengine/../Tongsuo-8.3.2/.openssl" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "--prefix=/home/qnwang/worknew/AR/tengine/../Tongsuo-8.3.2/.openssl" ],
  ...
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_ASAN", "OPENSSL_NO_CERT_COMPRESSION", "OPENSSL_NO_COMPATIBLE_GM_VER", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_CRYPTO_MDEBUG_COUNT", "OPENSSL_NO_DELEGATED_CREDENTIAL", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DYCERT_OCSP", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_EVP_CIPHER_API_COMPAT", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_NTLS", "OPENSSL_NO_REQ_STATUS", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_STATUS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [  ],
  openssldir => "",
  options => "--prefix=/home/qnwang/worknew/AR/tengine/../Tongsuo-8.3.2/.openssl no-asan no-buildtest-c++ no-cert-compression no-compatible-gm-ver no-crypto-mdebug no-crypto-mdebug-backtrace no-crypto-mdebug-count no-delegated-credential no-devcryptoeng no-dycert-ocsp no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-evp-cipher-api-compat no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-ntls no-rc5 no-req-status no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-status no-threads no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.38.2",
  perlargv => [ "linux-x86_64", "--prefix=/home/qnwang/worknew/AR/tengine/../Tongsuo-8.3.2/.openssl", "no-shared", "no-threads" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/qnwang/worknew/AR/tengine/../Tongsuo-8.3.2/.openssl",
  processor => "",
  rc4_int => "unsigned int",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "bf", "cast", "camellia", "seed", "sm4", "chacha", "zuc", "eia3", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %unified_info = (
            ...
            "crypto/asn1" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/asn1/x_delegated_credential.o",
            ...
            "crypto/eia3" =>
                {
                    "deps" =>
                        [
                            "crypto/eia3/eia3.o",
                            "crypto/eia3/eia3_ameth.o",
                            "crypto/eia3/eia3_pmeth.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "crypto/kdf" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/kdf/kdf_util.o",
                            "crypto/kdf/krb5kdf.o",
                            "crypto/kdf/pbkdf2.o",
                            "crypto/kdf/scrypt.o",
                            "crypto/kdf/sshkdf.o",
                            "crypto/kdf/sskdf.o",
            ...
            "ssl/statem_ntls" =>
                {
                    "deps" =>
                        [
                            "ssl/statem_ntls/extensions.o",
                            "ssl/statem_ntls/extensions_clnt.o",
                            "ssl/statem_ntls/extensions_cust.o",
                            "ssl/statem_ntls/extensions_srvr.o",
                            "ssl/statem_ntls/statem.o",
                            "ssl/statem_ntls/statem_clnt.o",
                            "ssl/statem_ntls/statem_lib.o",
                            "ssl/statem_ntls/statem_ntls.o",
                            "ssl/statem_ntls/statem_ntls_clnt.o",
                            "ssl/statem_ntls/statem_ntls_srvr.o",
                            "ssl/statem_ntls/statem_srvr.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
    ...
    "includes" =>
        {
            ...
            "test/ec_elgamal_internal_test.o" =>
                [
                    ".",
                    "include",
                ],
    ...
    "rawlines" =>
        [
            ...
            "",
            "# GNU make \"catch all\"",
            "crypto/sm3/sm3-%.S:	crypto/sm3/asm/sm3-%.pl",
            "	CC=\"\$(CC)\" \$(PERL) \$< \$(PERLASM_SCHEME) \$\@",
            "",
            ...
            "",
            "# GNU make \"catch all\"",
            "crypto/sm4/sm4-%.S:	crypto/sm4/asm/sm4-%.pl",
            "	CC=\"\$(CC)\" \$(PERL) \$< \$(PERLASM_SCHEME) \$\@",
            "",
    ...
    "sources" =>
        {
            ...
            "crypto/eia3/eia3_ameth.o" =>
                [
                    "crypto/eia3/eia3_ameth.c",
                ],
            "crypto/eia3/eia3_pmeth.o" =>
                [
                    "crypto/eia3/eia3_pmeth.c",
                ],
            "crypto/engine/eng_all.o" =>
                [
            ...
            "ssl/statem_ntls/extensions.o" =>
                [
                    "ssl/statem_ntls/extensions.c",
                ],
            "ssl/statem_ntls/extensions_clnt.o" =>
                [
                    "ssl/statem_ntls/extensions_clnt.c",
                ],
            "ssl/statem_ntls/extensions_cust.o" =>
                [
                    "ssl/statem_ntls/extensions_cust.c",
                ],
            "ssl/statem_ntls/extensions_srvr.o" =>
                [
            ...
            "ssl/statem_ntls/statem.o" =>
                [
                    "ssl/statem_ntls/statem.c",
                ],
            "ssl/statem_ntls/statem_clnt.o" =>
                [
                    "ssl/statem_ntls/statem_clnt.c",
                ],
            "ssl/statem_ntls/statem_lib.o" =>
                [
                    "ssl/statem_ntls/statem_lib.c",
                ],
            "ssl/statem_ntls/statem_ntls.o" =>
                [
                    "ssl/statem_ntls/statem_ntls.c",
                ],
            "ssl/statem_ntls/statem_ntls_clnt.o" =>
                [
                    "ssl/statem_ntls/statem_ntls_clnt.c",
                ],
            "ssl/statem_ntls/statem_ntls_srvr.o" =>
                [
                    "ssl/statem_ntls/statem_ntls_srvr.c",
                ],
            "ssl/statem_ntls/statem_srvr.o" =>
                [
                    "ssl/statem_ntls/statem_srvr.c",
                ],
            "ssl/t1_enc.o" =>
                [
                    "ssl/t1_enc.c",
            ...
            "test/ec_elgamal_internal_test.o" =>
                [
                    "test/ec_elgamal_internal_test.c",
                ],
            "test/ec_internal_test" =>
                [
                    "test/ec_internal_test.o",
...
my %disabled_info = (
    ...
    'cert-compression' => {
        macro => 'OPENSSL_NO_CERT_COMPRESSION',
    },
    'compatible-gm-ver' => {
        macro => 'OPENSSL_NO_COMPATIBLE_GM_VER',
    },
    'crypto-mdebug' => {
